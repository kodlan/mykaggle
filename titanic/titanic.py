...
model.compile(loss='binary_crossentropy', optimizer=K.optimizers.SGD(lr=0.001), metrics=['accuracy'])

my_logger = MyLogger(n=100)
h = model.fit(X, Y, batch_size=32, epochs=30000, verbose=0, callbacks=[my_logger])
